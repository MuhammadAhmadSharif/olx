...
class BuyMessageScreen extends StatefulWidget {
  const BuyMessageScreen({super.key});

  @override
  State<BuyMessageScreen> createState() => _BuyMessageScreenState();
}

class _BuyMessageScreenState extends State<BuyMessageScreen> {
  var user;
  var userdata;
  bool _loading = false;
  ...
  Future<void> getUser() async {
    ...
    var response = await ApiService().findallbuy(userdata);
  ...
  Widget build(BuildContext context) {
    return NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: FutureBuilder(
            future: ApiService().findallbuy(userdata),
