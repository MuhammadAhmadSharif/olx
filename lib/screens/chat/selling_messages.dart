...
import 'package:olx/screens/chat/all_message.dart';

import '../../config/auth.dart';
import '../../config/config.dart';
import '../../config/service.dart';

class SellingMessageScreen extends StatefulWidget {
  const SellingMessageScreen({super.key});

  @override
  State<SellingMessageScreen> createState() => _SellingMessageScreenState();
}

class _SellingMessageScreenState extends State<SellingMessageScreen> {
  var user;
  var userdata;
  bool _loading = false;
  ...
  Future<void> getUser() async {
    ...
    var response = await ApiService().findallSelling(userdata);
  ...
  Widget build(BuildContext context) {
    return NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: FutureBuilder(
            future: ApiService().findallSelling(userdata),
