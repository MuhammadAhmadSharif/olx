...
class _CategoryGridScreenState extends State<CategoryGridScreen> {
  Future<void> getads(id) async {
    setState(() {
      _loading = true;
    });
    da = {"subcategoryId": widget.subcategoryID};

    var response = await ApiService().findads(da);
  ...
  @override
  void initState() {
    log(widget.filterName.toString());
    subCategories.clear();
    getads(widget.subcategoryID);
    ...
    return SafeArea(
      ...
      body: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: _loading
            ...
            : ListView(padding: EdgeInsets.symmetric(horizontal: 8), children: [
                Container(
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => FilterScreen(
                                  categoryName: widget.filterName,
                ...
                Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "${subCategories.length}" + " Results for Mobiles",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
                              fontWeight: FontWeight.bold),
